...
var FNTS = {
	...
	"list": [
		...
		",Bold Italic,,,,",
		",ExtraBold,,,,",
		",ExBold Italic,SairaCondensed-ExtraBoldItalic,,,",
		",ExtraLight,,,,",
		",ExLight Italic,SairaCondensed-ExtraLightItalic,,,",
		",Italic,,,,",
		",Light,,,,",
		",Light Italic,,,,",
		",Medium,,,,",
		...
		",Black It,SairaExtraCondensed-BlackItalic,,,",
		",Bold,,,,",
		",Bold Italic,,,,",
		",ExtraBold,,,,",
		",ExBold It,SairaExtraCondensed-ExtraBoldItalic,,,",
		",ExtraLight,,,,",
		",ExLight It,SairaExtraCondensed-ExtraLightItalic,,,",
		",Italic,,,,",
		",Light,,,,",
		",Light It,SairaExtraCondensed-LightItalic,,,",
		",Medium,,,,",
		",Medium It,SairaExtraCondensed-MediumItalic,,,",
		",Regular,,,,",
		",SemiBold,,,,",
		",SmBold It,SairaExtraCondensed-SemiBoldItalic,,,",
		",Thin,,,,",
		",Thin It,SairaExtraCondensed-ThinItalic,,,",
		"Saira SemiCondensed,Black,,,,",
		",Black It,SairaSemiCondensed-BlackItalic,,,",
		",Bold,,,,",
		",Bold Italic,,,,",
		",ExtraBold,,,,",
		",ExBold It,SairaSemiCondensed-ExtraBoldItalic,,,",
		",ExtraLight,,,,",
		",ExLight It,SairaSemiCondensed-ExtraLightItalic,,,",
		",Italic,,,,",
		",Light,,,,",
		",Light It,SairaSemiCondensed-LightItalic,,,",
		",Medium,,,,",
		",Medium It,SairaSemiCondensed-MediumItalic,,,",
		",Regular,,,,",
		",SemiBold,,,,",
		",SmBold It,SairaSemiCondensed-SemiBoldItalic,,,",
		",Thin,,,,",
		",Thin Italic,,,,",
...
var LNKS = [
	...
	[0.2, "img/pp_tall.png", "img/pp_wide.png"],
	[0, "img/war.png", "img/war_wide.png", "", "", "", "war"],

	[0.1, "img/mog/cola.jpg", "img/mog/cola_w.jpg", "//t.ly/rmxCj", "", "", "colafactory"],
	[0.1, "img/mog/conn.jpg", "img/mog/conn_w.jpg", "//t.ly/jGydI", "", "", "connection"],
	[0.1, "img/mog/din2.jpg", "img/mog/din2_w.jpg", "//t.ly/SOFw-", "", "", "dinohunt2"],
	[0.1, "img/mog/loud.jpg", "img/mog/loud_w.jpg", "//t.ly/k9CHk", "", "", "loudrider"],
	[0.2, "img/mog/moon.jpg", "img/mog/moon_w.jpg", "//t.ly/VXXSy", "", "", "moonsters"],
	[0.1, "img/mog/tiny.jpg", "img/mog/tiny_w.jpg", "//shorturl.at/goJ36", "", "", "tinymonsters"],
	[0.1, "img/as-yayimages-160x600.png", "img/as-yayimages-300x250.png", "", "", "", "yay images", 1719881305075]
	...
	"tables": [
		[
			[
				...
				"Log In",
				"Log Out",
				"Create translation::Click it to get to www.Photopea.com/translate",
				[
					"Account",
					"Terms of Service",
					"Back",
					"About::\"About a program\" - the orange button at the top",
					"Report a bug",
					"Learn"
				],
				"More",
				...
				"Use WebGL",
				[
					"Photopea: advanced image editor::The header at the top of the page",
					"Free online editor supporting PSD, AI, PDF, SVG and CDR formats.::Will be at the top of the page",
					"Create a new image or open existing files from your computer. Save your work as PSD (File - Save as PSD) or as JPG / PNG / SVG (File - Export as).::Will be at the top of the page",
					"Suggest new features at our <GitHub> or <Facebook>. Our goal is to create <the most advanced and affordable photo editor>.::Parts between < and > will become links.",
					"Sponsor links open in a new window.",
			...
			[
				...
				"Save::verb",
				"Save as PSD",
				"Print::Press to print on a printer",
				"Open from URL",
				"Open From Computer",
				...
				"Export Layers",
				"Script",
				"Open & Place::Open a document and insert it into a current document",
				[
					"Close",
					"OK::if you keep it empty, \"OK\" will be used",
					"Reset::if you keep it empty, \"Reset\" will be used"
				],
				"Local Storage",
				"File Info",
				"Preset Manager",
				...
				[
					...
					"Home",
					"This Device",
					"Give VAR0 a direct access to VAR1.::VAR0 will be replaced with Photopea, and VAR1 will be replaced with Goolge Drive, Dropbox, etc."
				],
				null
			],
			[
				"Step Forward::In history of changes",
				"Step Backward::In history of changes",
				"Clear::Verb, press to clear the selected area",
				"Fill::Verb, press to fill the selected area",
				"Transform::Transform the image",
				"Rotate",
				"Flip VAR0::VAR0 will be replaced with Horizontally/Vertically",
				"Scale VAR0::VAR0 will be replaced with Horizontally/Vertically",
				"Undo / Redo",
				"Perspective",
				[
					"Auto-Blend::Auto-Blend layers together",
					"Auto-Align::Auto-Align layers against each other"
				],
				"Fade",
				"Apply Image",
				"Defringe",
			...
			[
				"Cut",
				"Copy",
				"Paste::like \"insert\", not like \"toothpaste\"",
				"New",
				"Delete",
				"Enable",
				"Disable",
				"Copy Merged::Copy not from a layer, but from all layers (all merged together)",
				"Apply::Apply Mask - \"combine\" it with a layer",
				"Again::Repeat the same aciton one more time",
				"Update::A verb"
			],
			[
				"Duplicate Layer",
				...
				"Raster Mask",
				"Vector Mask",
				"Add (Reveal All)::Add a mask",
				[
					"Add (Hide All)::Add a mask",
					"Reveal Selection",
					"Hide Selection",
					"From Transparency"
				],
				...
				"Rasterize::Convert Text layer/vector layer to pixels",
				"Group Layers::Put selected layers into a new group",
				"Merge Down::Merge a layer with one below it",
				"Merge Up::Merge a layer with one above it",
				[
					"Merge Layers::Merge selected layers",
					"Flatten Image::Merge all layers in a document into one"
				],
				"New Layer",
				"Enable Raster Mask",
				"Disable Raster Mask",
				...
				"Layer Order::Name of the step, when reordering layers",
				[
					"Creating Smart Object",
					"Updating Smart Object",
					"Placing Smart Object",
					"Source (Smart Object)",
					"Stack Mode::the mode of combining (stacking) multiple images into one"
				],
				"Name Change",
				"Color Change",
				...
				[
					...
					"Lock Change",
					"Lock::noun - a lock on a layer"
				],
				"Animation"
			],
			[
				"All::As in Select - All",
				"Deselect",
				"Inverse",
				"Modify",
				"Expand::Expand Selection",
				"Contract",
				"Feather::Feather (blur) a Selection",
				"Move Selection",
				"Color Range",
				"Border::The border of a Selection",
				"Transform Selection",
				"Refine Edge::A tool for improving the edge of a selection",
				"Heal Selection",
				"Magic Cut",
			...
			[
				"Zoom In",
				"Zoom Out",
				"Guides::Vertical and horizontal lines over the image, to help us be more precise",
				"Rulers",
				"Grid",
				"Snap::When moving objects, they will \"stick\" to other objects, guides, etc.",
				"Snap To",
				[
					"Document Bounds",
					"All Documents"
				...
				"Pixel Grid",
				"Paths::Elements of vector graphics",
				"Snap to Pixels",
				[
					"Slices",
					"Slice Options",
				...
				"Show::A verb: to show.",
				"Extras::Visual elements, that are not printed (guides, grid, selections ...)",
				"Pattern Preview"
			],
			[
				"History::History of steps",
				"Layers",
				"Properties",
				"Brush::A brush tool",
				"Character::= a Letter (like a, b, c, ...)",
				"Paragraph",
				"Info",
				"Layer Comps::Compositions of layers",
				"Swatches::Gallery of colors",
				"Actions",
				"Histogram::Usually the same in other languages",
				"Navigator",
				"Tool Presets",
				"Glyphs",
				"Notes"
			...
			[
				...
				"Eraser Tool",
				"Ellipse Select",
				"Eyedropper::A tool to pick color from the image",
				"Gradient Tool",
				"Hand Tool::To move (pan) across the image area",
				"Type Tool",
				"Lasso Select",
				...
				"Sharpen Tool",
				"Smudge Tool",
				"Dodge Tool::Make Brighter",
				"Burn Tool::Make Darker",
				"Sponge Tool::Desaturate",
				"Spot Healing Brush Tool",
				"Healing Brush Tool",
				"Patch Tool::Cut from one place and put to another place",
				"Path Select::a tool to select / move paths",
				"Direct Select::a tool to select / move knots of paths",
				"Pen",
				"Free Pen::Draw freely with this pen",
				"Custom Shape",
				"Rectangle",
				"Ellipse",
				"Parametric Shape",
				"Line",
				"Ruler::A ruler tool to measure distances",
				"Quick Selection",
				"Pencil Tool",
				"Perspective Crop",
				"Slice Tool",
			...
			[
				"Take a picture::Press the button to take a picture",
				"Color Picker",
				"Contour Editor",
				"Canvas Size",
				"Duplicate Into ...",
				...
				"Image Size",
				[
					"Vectorize Bitmap::Convert raster pixels into vector paths",
					"Reduce Colors::Reduce the number of colors in the image (Edit - Reduce Colors)"
				],
				[
					"Trim::cut away an empty area around the object",
					"Crop::(verb) Crop the image",
					"Reveal All"
				],
				"Keyboard Shortcuts",
				"Add Guides",
			...
			[
				...
				[
					"Blend Mode",
					"Blend If::Specifies a tonal range for blending"
				],
				[
					"Sample Size",
					"Sampling Ring"
				...
				[
					"Reverse",
					"Relative::When ON, you only write a number, which will be added to the original value",
					"Anchor::To which side the object should be anchored",
				...
				[
					...
					"Sample All Layers",
					"Resample",
					"Continuous::adapt continuously, while moving",
					"Once::one time"
				],
				"Fill::Noun, the content (filling) of something.",
				"Use global angle",
				"Distance",
				"Spread::Spread the effected area",
				"Noise::add random image noise",
				"Knock out drop shadow::No drop shadow behind the object",
				"Technique",
				"Direction",
				"Depth",
				"Soften",
				"Mode::One of possible modes of the effect",
				"Gradient::from one color to another",
				"Scale::scale the content - 10% or even 200%",
				"Align with layer",
				...
				"Foreground",
				"Background",
				"Custom::Color: not foreground or background, but a custom color",
				...
				"Duplicate",
				"Move::When you move layers, the Move step will be added to History",
				"Smart Filters",
				"Radius",
				"Amount::Strength of the effect (0 ... 100)",
				"Distribution",
				[
				...
				"Monochromatic",
				"Cell Size::Mosaic filter creates \"cells\"",
				"Pattern",
				"Flow::A brush has the opacity and the flow",
				"Strength",
				"Protect Detail",
				"Fill Type",
				"Texture",
				"Jitter::Add Noise in Outer Glow",
				"Edge::The inner glow is either from the center, or from the Edge",
				"Source",
				"Target",
				"Channels",
				"Mask::A noun, e.g. a vector mask or a raster mask ",
				"Density",
				"Aligned",
				[
					"Path",
				...
				"Colors",
				"Distances",
				"Rate::Liquify filter: Rate of modification",
				"Auto-Select::Move tool option: click the object to select its layer",
				"Find",
				"Define New",
				[
					"Photo",
				...
				[
					"Free::Not Restricted / Not Limited",
					"Fixed Ratio",
					"Fixed Size"
				],
				"Help",
				[
					"Live Shape::Shape, that can be reconstructed from parameters at any time",
					"Edit Live Shape",
					"Same Radii::all radiuses of a rectangle should be the same"
				],
				"Fuzziness",
				[
					"Polygon",
			...
			[
				...
				[
					...
					"Cyan::A color",
					"Magenta::A color",
					"Neutral::Apply to neutral colors"
				],
				"Total",
				"Absolute",
				"Preserve Luminosity",
			...
			[
				...
				"Pattern Overlay",
				"Satin",
				"Stroke::Thick line around an object",
				"Blending Options",
				"Select Pixels"
			],
			[
				"Tip Shape",
				"Tip Dynamics",
				"Scatter::dont put brush exactly, but randomly around the target spot",
				"Color Dynamics",
				[
					"Size Jitter::change the size randomly",
					"Minimal Diameter",
					"Angle Jitter::change the angle randomly",
					"Roundness Jitter::change the roundness randomly",
					"Minimal Roundness"
				],
				[
					"Position Jitter",
					"Count::The number of brush tips",
					"Count Jitter"
				],
				[
				...
				[
					...
					"Straighten Layer::Will rotate the layer, so that the horizon is horizontal",
					"Open a document first.",
					"Close the current window first.",
					"Current Tool Only::Tool Presets only for the current tool",
					"Delete Cropped Pixels"
				],
				[
					"Record::To record actions",
					"New Action Set",
					"New Action"
				],
				[
					"Stylus Pressure controls Opacity",
					"Stylus Pressure controls Size"
				],
				[
					"Normal::One of Blend Modes (when empty, English version will be used)",
					"Dissolve::One of Blend Modes (when empty, English version will be used)",
					"Darken::...",
					"Multiply::...",
					"Color Burn::...",
					"Linear Burn::...",
					...
					"Color",
					"Luminosity",
					"Pass Through::Blend Mode only for Folders",
					"Add::Mathematically"
				],
				null
			],
			[
				"Leading::Text style - vertical distance between lines",
				"Tracking::Text style - horizontal spacing between characters",
				"Baseline shift::Move the bottom line of the text",
				[
			...
			[
				...
				"Current Layer",
				"Selection",
				"Current & Below::Current layers and all layers below it"
			],
			[
				"Replace::The new thing replaces the old one",
				"Unite",
				"Subtract",
				"Intersect",
				"Exclude",
			...
			[
				...
				[
					...
					"Pillow Emboss",
					"Stroke Emboss",
					"Stroke Width::The thickness of the stroke line (contour)"
				],
				[
					"Smooth::A verb: to smooth something",
					"Chisel Hard",
					"Chisel Soft",
					"Smoothness"
				],
				...
				[
					...
					"Center",
					"Inside",
					"From Center::Draw an object from the center"
				],
				[
					"Shadows",
					"Midtones",
			...
			[
				...
				"Transform controls",
				"Pixel to Pixel::Zoom the image to 100% (1 image pixel = 1 screen pixel)",
				"Fit The Area",
				[
					"Align Left Edges",
					"Center Horizontally",
					...
					"Center Vertically",
					"Align Bottom Edges",
					"Equal Gaps::Equal spacing between objects"
				],
				null
			],
			[
				"Place into::Place the new photo into:",
				"Current Project",
				"New Project",
				"Resolution",
			...
			[
				...
				"Bend::Text warping: bend the text to a wave, etc.",
				...
				[
					...
					"There is unsaved work in::File name will be added after this",
			...
			[
				...
				"added::Font was added",
				"Move Guide",
				"Delete Guide",
				"Add Guide",
				"Loading",
				"Load VAR0::Keep VAR0 in a phrase, it will be replaced with a Noun when used"
			],
			[
				"Filter Gallery",
				[
					[
						"Liquify::A filter",
						[
							"Smudge::Draw over image to spread colors along your stroke",
							"Reconstruct::Recover to original state",
							"Smoothen::Make the effect more smooth",
							"Twirl::Rotate in a spiral",
							"Shrink::Make smaller",
							"Blow::Make bigger",
							"Push Left::ush colors to the left along the stroke",
							"Freeze",
							"Unfreeze"
						],
						null
				...
				"Blur::A noun",
				[
					"Average::Average filter - fills the image with an average color",
					"Blur:: A verb",
					"Blur More",
					"Box Blur",
					"Gaussian Blur",
				...
				"Distort",
				[
					"Displace::Filter: move parts of image according to the brightness from another image",
					"Pinch::Blow or shring around the center",
					"Polar Coordinates",
					"Ripple::Add tiny waves to the image",
					"Shear",
					"Spherize",
					"Wave",
					"ZigZag",
				...
				"Other",
				[
					"Custom::A Custom kernel of the convolution",
					"High Pass",
					"Maximum",
					"Minimum",
					"Offset::Filter: shift the image horizontally and vertically",
					"Repeat::Filter: Repeat the image many times",
					"Color to Alpha::this filter makes a specific color transparent",
					"Particles",
					"Normal Map"
				],
				[
				...
				[
					"Colored Pencil::Following phrases are Filters in the Filter Gallery. Keep them empty to keep the English version in Photopea.",
					"Cutout",
					"Dry Brush",
					"Film Grain",
					"Fresco",
					...
					"Patchwork",
					"Stained Glass",
					"Texturizer::The last filter in the Filter Gallery."
				],
				[
					"Edge Width",
					"Edge Brightness",
...
var CAMS = {
	...
	"om digital solutions:om-1markii": [
		[9090, -3591, -756, -3252, 11396, 2109, -318, 1059, 5606],
		1, 254, 4095
	],
