...
internal static class DesktopLanguage
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> Texts = new(StringComparer.OrdinalIgnoreCase)
    {
        ["en"] = new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["StartupFilesError"] = "Failed to start the application. File verification failed.",
        ...
        ["ru"] = new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["StartupFilesError"] = "Не удалось запустить приложение. Проверка файлов не пройдена.",
        ...
        ["uk"] = new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["StartupFilesError"] = "Не вдалося запустити застосунок. Перевірка файлів не пройдена.",
